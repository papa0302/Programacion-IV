...
import Robot.RobotFactoryMethod;
...
public class Main {
    ...
    */
    ...
    RobotFactoryMethod robot = new RobotFactory();
    Robot ro = robot.Pintar("nuevo robot","aerosol","azul");
    Robot ro1 = robot.Pintar("viejo robot","brocha","rojo");
    Robot ro2 = robot.Pintar("viejo robot","rodillo","azul");
        System.out.println( ro.getDescripcion());
        System.out.println("");
        System.out.println( ro1.getDescripcion());
        System.out.println("");
        System.out.println(ro2.getDescripcion());
        System.out.println("");
